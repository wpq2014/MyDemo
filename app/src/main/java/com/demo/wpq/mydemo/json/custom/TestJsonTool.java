...
public class TestJsonTool {
    ...
    static String json1 = "{\"ids\":[1, 2, 3, 4, 5], \"objectBean\":{\"msg\":\"hello\", \"objectChild\":{\"name\":\"雷布斯\"}, \"list\":[{\"name\":\"雷布斯\"}, {\"name\":\"马斯克\"}]}, \"error\": false, \"results\":[{\"listChild\":[{\"age\":666}, {\"age\":999}], \"type\":\"福利\", \"who\":\"代码家\", \"resultChild\":{\"child\":\"呵呵哒\"}}]}";

...
package com.demo.wpq.mydemo.customview.progressbar;
...
public class QLKCircleProgressBar extends ImageView {
    ...
    private QLKCircleProgressDrawable mProgressDrawable;
    private ShapeDrawable mBgCircle;
    private boolean mCircleBackgroundEnabled;

    private int[] mColors = new int[]{R.color.colorPrimary};

    public QLKCircleProgressBar(Context context) {
        super(context);
        init(context, null, 0);

    }

    public QLKCircleProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);

    }

    public QLKCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.QLKCircleProgressBar, defStyleAttr, 0);
...
//        </attr>
        ...
        mBackGroundColor = a.getColor(
                R.styleable.QLKCircleProgressBar_mlpb_background_color, DEFAULT_CIRCLE_BG_LIGHT);

        mProgressColor = a.getColor(
                R.styleable.QLKCircleProgressBar_mlpb_progress_color, DEFAULT_CIRCLE_BG_LIGHT);
        mColors = new int[]{mProgressColor};

        mInnerRadius = a.getDimensionPixelOffset(
                R.styleable.QLKCircleProgressBar_mlpb_inner_radius, -1);

        mProgressStokeWidth = a.getDimensionPixelOffset(
                R.styleable.QLKCircleProgressBar_mlpb_progress_stoke_width, (int) (STROKE_WIDTH_LARGE * density));
        mArrowWidth = a.getDimensionPixelOffset(
                R.styleable.QLKCircleProgressBar_mlpb_arrow_width, -1);
        mArrowHeight = a.getDimensionPixelOffset(
                R.styleable.QLKCircleProgressBar_mlpb_arrow_height, -1);
        mTextSize = a.getDimensionPixelOffset(
                R.styleable.QLKCircleProgressBar_mlpb_progress_text_size, (int) (DEFAULT_TEXT_SIZE * density));
        mTextColor = a.getColor(
                R.styleable.QLKCircleProgressBar_mlpb_progress_text_color, Color.BLACK);

        mShowArrow = a.getBoolean(R.styleable.QLKCircleProgressBar_mlpb_show_arrow, false);
        mCircleBackgroundEnabled = a.getBoolean(R.styleable.QLKCircleProgressBar_mlpb_enable_circle_background, true);


        mProgress = a.getInt(R.styleable.QLKCircleProgressBar_mlpb_progress, 0);
        mMax = a.getInt(R.styleable.QLKCircleProgressBar_mlpb_max, 100);
        int textVisible = a.getInt(R.styleable.QLKCircleProgressBar_mlpb_progress_text_visibility, 1);
        if (textVisible != 1) {
            mIfDrawText = true;
        }
        ...
        a.recycle();
        mProgressDrawable = new QLKCircleProgressDrawable(getContext(), this);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int viewWidth = QLKCircleProgressBar.this.getWidth();
            final int viewHeight = QLKCircleProgressBar.this.getHeight();

...
import com.demo.wpq.mydemo.qrcode.utils.BeepManager;
import com.demo.wpq.mydemo.qrcode.utils.CaptureActivityHandler;
import com.demo.wpq.mydemo.qrcode.utils.InactivityTimer;
...
//		captureErrorMask.setVisibility(View.GONE);
	 ...
	 * @param v
     */
	public void clickQRCodeCreate(View v){
		startActivity(new Intent(this, QRCodeCreateActivity.class));
	}
}
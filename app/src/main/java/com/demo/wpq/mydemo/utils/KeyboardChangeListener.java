...
public class KeyboardChangeListener implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private OnKeyboardListener mOnKeyBoardListen;
    ...
    public void setOnKeyBoardListener(OnKeyboardListener onKeyboardListen) {
        this.mOnKeyBoardListen = onKeyboardListen;
    }
    ...
    public void onGlobalLayout() {
        ...
        if (hasChange) {
            ...
            if (mOnKeyBoardListen != null) {
                mOnKeyBoardListen.onKeyboardChange(isShow, keyboardHeight);
            }
        }
    }

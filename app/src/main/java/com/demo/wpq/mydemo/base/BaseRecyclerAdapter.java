...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerAdapter.RecyclerViewHolder>{
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        setListeners(parent, holder);
        return holder;
    }

    private void setListeners(final ViewGroup parent, final RecyclerViewHolder holder) {
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnItemClickListener != null) {
                    mOnItemClickListener.onItemClick(parent, holder.itemView, holder.getAdapterPosition());
                }
            }
        });
        ...
        holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                if (mOnItemLongClickListener != null) {
                    mOnItemLongClickListener.onItemLongClick(parent, holder.itemView, holder.getAdapterPosition());
                }
                return true;
            }
        });
